...
<header>
	<h1>FAQ</h1>
    {{--@for (($x=0; $x<10; Sx==)--}}
    {{--<h2>Используем blade </h2>--}}
    {{--@endfor--}}
	{{--@for($x=0; $x<100; $x++)--}}
		{{--<li>{{$x}}<h2>Используем blade </h2></li>--}}
	{{--@endfor--}}
</header>
...
<script src="../../../public/faq/js/jquery-2.1.1.js"></script>
<script src="../../../public/faq/js/jquery.mobile.custom.min.js"></script>
<script src="../../../public/faq/js/main.js"></script> <!-- Resource jQuery -->
</body>
</html>